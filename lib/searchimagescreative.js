...
class SearchImagesCreative extends GettyApiRequest {
    constructor(credentials, hostName) {
        ...
        this.excludeEditorialOnly = true;
        this.fields = [];
        this.fileTypes = [];
        ...
        this.numberOfPeople = [];
        this.facet_fields = ['locations'];
        this.include_facets = true;
        this.orientations = [];
        this.page = 0;
        this.pageSize = 0;
        this.phrase = null;
    ...
    execute(next) {
        ...
        addParameter(params, "exclude_editorial_use_only", this.excludeEditorialOnly);
        ...
        addParameter(params, "include_facets", this.include_facets);
        addParameter(params, "facet_fields", this.facet_fields);
    ...
    withExcludeEditorialOnly(excludeEditorialOnly) {
        this.excludeEditorialOnly = excludeEditorialOnly;
        return this;
    }
